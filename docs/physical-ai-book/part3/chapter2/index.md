...
```bash
# Chapter 2: Install ros_gz packages
...
```bash
# Chapter 2: Start Gazebo
gz sim empty_world.sdf

# Chapter 2: Bridge /cmd_vel topic
...
```bash
# Chapter 2: Bridge in both directions
...
```bash
# Chapter 2: Bridge camera images
...
```bash
# Chapter 2: List Gazebo topics
gz topic -l

# Chapter 2: List ROS 2 topics
ros2 topic list

# Chapter 2: Echo a topic
...
```bash
# Chapter 2: Check if bridge is running
ros2 node list | grep bridge

# Chapter 2: Check bridge info
