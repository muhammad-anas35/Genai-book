# 2.3 ROS 2 پیکجز بنانا (Building ROS 2 Packages)
...
# ورک اسپیس کو سورس کریں (لازمی قدم)
...
```bash
# تمام پیکجز کو بلڈ کریں
colcon build

# کسی مخصوص پیکج کو بلڈ کریں
colcon build --packages-select my_robot_package

# سم لنک انسٹال (ڈیولپمنٹ کے لیے بہترین)
...
**گزشتہ سیکشن**: [← 2.2 نوڈس اور کمیونیکیشن](./nodes-communication.md)  
**اگلا سیکشن**: [2.4 لانچ فائلز اور پیرامیٹرز →](./launch-parameters.md)
