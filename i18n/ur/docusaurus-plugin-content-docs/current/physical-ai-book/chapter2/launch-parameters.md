# 2.4 لانچ فائلز اور پیرامیٹرز (Launch Files and Parameters)
...
**لانچ فائلز (Launch Files)** اس مسئلے کو حل کرتی ہیں، جس سے آپ صرف ایک کمانڈ کے ساتھ متعدد نوڈس شروع کر سکتے ہیں، پیرامیٹرز سیٹ کر سکتے ہیں، اور اپنے پورے روبوٹ سسٹم کو کنفیگر کر سکتے ہیں۔
...
**گزشتہ سیکشن**: [← 2.3 ROS 2 پیکجز بنانا](./building-packages.md)  
**اگلا باب**: [باب 3: Gazebo کے ساتھ روبوٹ سیمولیشن →](../chapter3/index.md)
