...
# باب 2: ROS 2 کے بنیادی اصول (Fundamentals)
...
## 2.1 روبوٹک اعصابی نظام: ROS 2 کا تعارف
...
### 2.1.2 ROS 2 گراف (The ROS 2 Graph)
...
## 2.2 ROS 2 کے ساتھ بنانا: عملی ڈویلپمنٹ

یہ سیکشن ROS 2 ایپلی کیشنز بنانے کا عملی تجربہ فراہم کرتا ہے۔

### 2.2.1 اپنا ROS 2 ماحول ترتیب دینا
...
### 2.2.2 اپنا پہلا ROS 2 پیکج بنانا
...
### 2.2.3 اپنی ROS 2 ایپلی کیشن کو چلانا (Launching)
...
## 2.3 خلیج کو ختم کرنا: ROS 2 اور Python ایجنٹس
