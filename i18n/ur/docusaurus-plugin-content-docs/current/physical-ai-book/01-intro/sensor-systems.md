# 1.4 سینسر سسٹمز کا جائزہ (Sensor Systems Overview)
...
## 2. RGB-D کیمرے (Depth Cameras)

RGB-D کیمرے معیاری رنگین امیجنگ کو گہرائی (Depth) کی پیمائش کے ساتھ جوڑتے ہیں، جس سے بصری شکل اور 3D ساخت دونوں فراہم ہوتی ہیں۔
...
**گزشتہ سیکشن**: [← 1.3 ہیومنائیڈ روبوٹکس کا منظرنامہ](./humanoid-landscape.md)  
**اگلا باب**: [باب 2: ROS 2 کے بنیادی اصول →](../chapter2/index.md)
