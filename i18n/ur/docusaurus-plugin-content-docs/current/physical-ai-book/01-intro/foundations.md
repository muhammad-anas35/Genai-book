# 1.1 Physical AI کی بنیادیں (Foundations)
...
طبعی حقیقت میں یہ **گراؤنڈنگ (Grounding)** Physical AI سسٹمز کو ایسی صلاحیتیں دیتی ہے جو خالصتاً ڈیجیٹل سسٹمز حاصل نہیں کر سکتے: عمل کے ذریعے وجہ اور اثر (Causality) کو سمجھنا، تجربے کے ذریعے عام فہم (Common Sense) پیدا کرنا، اور حقیقی دنیا کی غیر متوقع نوعیت کے مطابق ڈھلنا۔
...
### 1. **ادراک / Perception** (دنیا کو محسوس کرنا)
...
### 2. **ادراک / Cognition** (سمجھنا اور سوچنا)
...
### 3. **عمل / Action** (دنیا کے ساتھ تعامل)
...
### 4. **سیکھنے کا لوپ / Learning Loop** (مسلسل بہتری)
...
## 2024 کا بریک تھرو: Embodied AI کا سال
...
### 1. **طرز عمل اور علمی ذہانت کا ملاپ**
...
### 2. **عام فہم (Common Sense) پیدا کرنا**
...
**اگلا سیکشن**: [1.2 ڈیجیٹل سے Embodied ذہانت تک →](./digital-to-embodied.md)
